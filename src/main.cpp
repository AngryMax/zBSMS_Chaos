...
BETTER_SMS_FOR_CALLBACK static void initVars(TApplication *tapp) { 
    ...
    Code addList[] = {
		...
		{CHANGE_LIVES,              "Life Changer",					    65,			 1,		    codeContainer.changeLives},
        ...
        {SUPERPOSITION,				"Superposition",					20,			20,		    codeContainer.superposition},
        {WIDE_MARIO,				"Elastic Mario",					55,			20,		    codeContainer.wideMario},
...
// Definition block
KURIBO_MODULE_BEGIN("Hyper Chaos", "Angry_Max, MasterMattK", "v0.91") {
