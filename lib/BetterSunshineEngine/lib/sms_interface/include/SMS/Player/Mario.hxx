...
public:
    ...
    enum State : u32 {
        ...
        STATE_HANGCLIMB_DOWN   = 0x3000054E,
		...
		STATE_GRABBING_EMPTY   = 0x00000384,
        ...
        STATE_G_POUND_GRATE    = 0x00200346,  // Flipping through a flip grate from ground pounding
        STATE_GRATE_GRAB       = 0x3000036C,  // Grabbing onto a horizontal grate
        STATE_GRATE_PUNCH      = 0x3000036A,  // Punching a horizontal grate
        STATE_GRATE_KICK       = 0x00200345,  // Kicking a flip grate from below
        STATE_GRATE_TRANSITION = 0x3000036B,  // Transitioning from hanging to clambering
        STATE_NPC_PUTDOWN      = 0x80000387,
        STATE_NPC_THROW        = 0x80000588,
        STATE_NPC_JUMPTHROW    = 0x820008AB,
        STATE_NPC_BOUNCE       = 0x02000890,
        STATE_INACTIVE         = 0x0000133F
    };
